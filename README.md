...
- Current changed component: **KOZ SEO Core 2.1.14**
...
**KOZ Suite Bundle 1.0.10** contains the 12 verified plugin ZIP packages. Release metadata and SHA-256 checksums are stored under `releases/`.
