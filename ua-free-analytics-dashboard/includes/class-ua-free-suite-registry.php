...
final class Registry {
	...
	public static function catalog(): array {
		return array(
			...
			'ua-free-donate-stats' => array( 'name' => 'UA FREE Donate Stats & Conversions', 'uk' => 'Воронка донатів, підтвердження та конверсія.', 'en' => 'Donation funnel, confirmations and conversion.' ),
			...
			'ua-free-analytics-dashboard' => array( 'name' => 'UA FREE Suite Control Center', 'uk' => 'Єдина аналітична панель екосистеми.', 'en' => 'Unified analytics dashboard for the suite.' ),
