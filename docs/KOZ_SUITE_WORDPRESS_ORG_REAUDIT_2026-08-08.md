...
Eight plugins have completed the stricter re-audit: KOZ Copy Actions 1.1.11, KOZ URL-Only Comment Spam 1.1.9, KOZ Consent Manager 0.2.10, KOZ Donate Stats & Conversions 1.3.9, KOZ Google Ads Campaign Builder 1.4.4, KOZ Migration & Cleanup 0.9.4, KOZ Static Translate 0.9.2 and KOZ Translate Diagnostics 0.3.2. The remaining four plugins are not considered current WordPress.org-ready until their re-audit is complete.
